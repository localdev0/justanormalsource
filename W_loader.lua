...
local function Hide(notify: boolean?)
	...
	if notify then
		if useMobilePrompt then 
			...
			RayfieldLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by tapping LeftControl.", Duration = 7, Image = 4400697855})
		end
	end
